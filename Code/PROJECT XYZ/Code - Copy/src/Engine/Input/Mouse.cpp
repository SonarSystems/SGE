...
namespace Sonar
{
    //Mouse::Cursor Mouse::CURSOR = Mouse::Cursor::Arrow;
	...
	//void Mouse::ChangeCursor( const Cursor &cursor, GameData data )
	//{
 //       sf::Cursor cursorLoader;

	//	if ( cursorLoader.loadFromSystem( ( sf::Cursor::Type )cursor ) )
 //       {
 //           data.window.setMouseCursor( cursorLoader );

 //           //CURSOR = cursor;
 //       }
	//}

	//const Sonar::Mouse::Cursor &Mouse::GetCurrentCursor( )
	//{ return CURSOR; }

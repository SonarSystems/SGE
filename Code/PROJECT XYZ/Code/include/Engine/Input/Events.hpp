...
namespace Sonar
{
    ...
    public:
        ...
        */
        ...
        /**
         * \brief Mouse buttons events parameters (MouseButtonPressed, MouseButtonReleased)
        */
        ...
        */
        ...
        /**
         * \brief Joystick connection events parameters (JoystickConnected, JoystickDisconnected)
        */
        ...
        */
        ...
        /**
         * \brief Joystick buttons events parameters (JoystickButtonPressed, JoystickButtonReleased)
        */

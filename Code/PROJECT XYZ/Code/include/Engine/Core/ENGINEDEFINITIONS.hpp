...
*/
#define DEFAULT_SLIDER_CURRENT_VALUE 0
#define DEFAULT_SLIDER_MINIMUM_VALUE 0
#define DEFAULT_SLIDER_MAXIMUM_VALUE 100
#define DEFAULT_SLIDER_BACKGROUND_COLOR Color::Black
#define DEFAULT_SLIDER_BACKGROUND_BORDER_THICKNESS 0
#define DEFAULT_SLIDER_BACKGROUND_BORDER_COLOR Color::Transparent
#define DEFAULT_SLIDER_KNOB_COLOR Color::Red
#define DEFAULT_SLIDER_KNOB_BORDER_THICKNESS 0
#define DEFAULT_SLIDER_KNOB_BORDER_COLOR Color::Transparent
#define DEFAULT_SLIDER_BACKGROUND_WIDTH 200
#define DEFAULT_SLIDER_BACKGROUND_HEIGHT 20
#define DEFAULT_SLIDER_KNOB_RADIUS 12